This section covers the work I had to do for an MLOps Zoomcamp course that was taken online.

Notes:

MLflow: an open source platform for the machine learning lifecycle. This contains four main modules:
